...
- [ ] **Интеграция с BIM-системами**:
    - [x] Подгрузка списка коллизий из Autodesk Navisworks (XML отчеты).
    - [ ] Распознавание коллизий по скриншотам/изображениям.
- [ ] **Справочники и Расценки**:
    - [x] Поддержка нескольких источников расценок (сметные базы, прайс-листы).
    - [x] Управление списком сайтов для парсинга (добавление, удаление, категоризация).
