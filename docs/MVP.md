...
- [x] Загрузка демо-данных из JSON файла (динамический импорт, кнопка в настройках)
- [x] Обновление README.md с описанием новой функции
- [x] Реализована возможность управления списком сайтов для парсинга в настройках: добавление, удаление, выбор из списка. В базовый список добавлены 7 строительных сайтов с описанием.
- [x] Реализован экспорт и импорт списка сайтов для парсинга (JSON), а также возможность сброса к демо-сайтам.
